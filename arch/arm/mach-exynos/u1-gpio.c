...
/******************************************************************/	
	...
	{EXYNOS4_GPA1(5), S3C_GPIO_INPUT,  S3C_GPIO_SETPIN_ZERO,
		S3C_GPIO_PULL_DOWN, S5P_GPIO_DRVSTR_LV2},
	{EXYNOS4_GPB(6),  S3C_GPIO_OUTPUT, S3C_GPIO_SETPIN_ZERO,
		S3C_GPIO_PULL_NONE,  S5P_GPIO_DRVSTR_LV2},
	{EXYNOS4_GPB(7),  S3C_GPIO_OUTPUT, S3C_GPIO_SETPIN_ZERO,
		S3C_GPIO_PULL_NONE,  S5P_GPIO_DRVSTR_LV2},
	{EXYNOS4_GPC0(0), S3C_GPIO_INPUT, S3C_GPIO_SETPIN_ZERO,
		S3C_GPIO_PULL_NONE,  S5P_GPIO_DRVSTR_LV2},
	{EXYNOS4_GPC0(2), S3C_GPIO_INPUT, S3C_GPIO_SETPIN_ZERO,
		S3C_GPIO_PULL_NONE, S5P_GPIO_DRVSTR_LV2},
...
/******************************************************************/	
...
#else
	{EXYNOS4_GPB(1),S3C_GPIO_INPUT,S3C_GPIO_SETPIN_ZERO,
		S3C_GPIO_PULL_DOWN, S5P_GPIO_DRVSTR_LV1},
#endif
	...
	{EXYNOS4_GPY6(7), S3C_GPIO_INPUT, S3C_GPIO_SETPIN_NONE,
		 S3C_GPIO_PULL_DOWN, S5P_GPIO_DRVSTR_LV1},
#if defined(CONFIG_MACH_C1_KDDI_REV00)
	{EXYNOS4_GPY3(1), S3C_GPIO_OUTPUT, S3C_GPIO_SETPIN_ONE,
		 S3C_GPIO_PULL_NONE, S5P_GPIO_DRVSTR_LV4},

	{EXYNOS4_GPY3(3), S3C_GPIO_OUTPUT, S3C_GPIO_SETPIN_ONE,
		 S3C_GPIO_PULL_NONE, S5P_GPIO_DRVSTR_LV4},
#endif
...
#if defined(CONFIG_TARGET_LOCALE_NA)
#if defined(CONFIG_MACH_C1_KDDI_REV00)
	{ EXYNOS4_GPC0(0),  S3C_GPIO_SLP_INPUT,	S3C_GPIO_PULL_NONE}, /* NFC_SDA */
#else
...
#if defined(CONFIG_TARGET_LOCALE_NA)
#if defined(CONFIG_MACH_C1_KDDI_REV00)
	{ EXYNOS4_GPC0(2),  S3C_GPIO_SLP_INPUT,	S3C_GPIO_PULL_NONE}, /* NFC_SCL */
#else
...
#if defined(CONFIG_MACH_C1_KDDI_REV00)
	{EXYNOS4_GPL2(4), S3C_GPIO_SLP_INPUT, S3C_GPIO_PULL_NONE}, /* CHG */
...
#elif !defined(CONFIG_MACH_U1_NA_SPR) && !defined (CONFIG_MACH_C1_KDDI_REV00)
...
void u1_config_gpio_table(void)
{
	...
	/* Initialize GPF0-2 */
	for (i = 0; i < 8; i++) {
		s3c_gpio_cfgpin(EXYNOS4_GPF0(i), S3C_GPIO_INPUT);
		s3c_gpio_setpull(EXYNOS4_GPF0(i), S3C_GPIO_PULL_DOWN);
		s3c_gpio_cfgpin(EXYNOS4_GPF1(i), S3C_GPIO_INPUT);
		s3c_gpio_setpull(EXYNOS4_GPF1(i), S3C_GPIO_PULL_DOWN);
		s3c_gpio_cfgpin(EXYNOS4_GPF2(i), S3C_GPIO_INPUT);
